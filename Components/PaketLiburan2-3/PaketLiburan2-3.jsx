    ...
    <div className='need-inspiration-section2 py-5 position-relative'>
            ...
            <div className="row">
                <div className='col-md-12 z-2'>
                    <div className='d-flex justify-content-between align-items-center'>
                        <h5 className='text-start text-light text-capitalize fw-semibold'>Paket D</h5>
                    ...
                    <div className='col-md-12 z-2'>
                        ...
                        Paket D menawarkan pemandu wisata untuk perjalanan liburanmu, tersedia makan, penginapan serta pilihan tempat wisata yang dapat kamu tentukan.
                        </p>
                    </div>
                </div>
                <div>
        ...
        <Modal className="custom-modal" show={show} onHide={handleClose}>
            <Modal.Header closeButton>
                <Modal.Title>Detail Paket D</Modal.Title>
            </Modal.Header>
            <Modal.Body>
...
export default PaketLiburanSection5;
