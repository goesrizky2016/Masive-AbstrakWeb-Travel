...
import './PaketLiburan2-1.css';
import { Modal, Button, Container } from 'react-bootstrap';
import { Link } from 'react-router-dom';

function PaketLiburanSection3() {
    ...
    <div className='need-inspiration-section2 py-5 position-relative'>
            ...
            <div className="row">
                <div className='col-md-12 z-2'>
                    <div className='d-flex justify-content-between align-items-center'>
                        <h5 className='text-start text-light text-capitalize fw-semibold'>Paket B</h5>
                    ...
                    <div className='col-md-12 z-2'>
                        ...
                        Paket B menawarkan pemandu wisata untuk perjalanan liburanmu,  tersedia makan dan pilihan tempat wisata dengan total maksimal 5 destinasi tempat wisata yang dapat kamu tentukan.
                        </p>
                    </div>
                </div>
                <div>
        ...
        <Modal className="custom-modal" show={show} onHide={handleClose}>
            <Modal.Header closeButton>
                <Modal.Title>Detail Paket B</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                        ...
                        <div className="row">
                            <div className='col-md-12 z-2'>
                                <div className='d-flex align-items-center'>
                                    <h4 className='text-center text-dark text-capitalize fw-semibold'>Paket B</h4>
...
export default PaketLiburanSection3;
