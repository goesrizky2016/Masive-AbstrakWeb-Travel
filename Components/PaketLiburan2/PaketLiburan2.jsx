...
import './PaketLiburan2.css';
import { Modal, Button, Container } from 'react-bootstrap';
import { Link } from 'react-router-dom';

function PaketLiburanSection2() {
    ...
    <div className='need-inspiration-section2 py-5 position-relative'>
            ...
            <div className="row">
                <div className='col-md-12 z-2'>
                    <div className='d-flex justify-content-between align-items-center'>
                        <h5 className='text-start text-light text-capitalize fw-semibold'>Paket A</h5>
        ...
        <Modal className="custom-modal" show={show} onHide={handleClose}>
            <Modal.Header closeButton>
                <Modal.Title>Detail Paket A</Modal.Title>
            </Modal.Header>
            <Modal.Body>
...
export default PaketLiburanSection2;
