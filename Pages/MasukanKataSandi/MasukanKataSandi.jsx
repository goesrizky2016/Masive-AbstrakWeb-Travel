...
import MasukanKataSandi from '../../Components/MasukanKataSandi/MasukanKataSandi'
...
function MasukanSandi() {
    return (
        <div className='masukan-kata-sandi'>
            <MasukanKataSandi />
            {/* <SearchForm /> */}
            {/* <LastHolidaysSection /> */}
